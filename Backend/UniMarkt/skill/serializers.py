...
from .models import Department, Degree, AvailableTimeSlot, Skill, SkillCategory
...
class SkillSerializer(serializers.ModelSerializer):
    ...
    skill_category_id = serializers.PrimaryKeyRelatedField(queryset=SkillCategory.objects.all(), source='skill_category', write_only=True)
    department_id = serializers.PrimaryKeyRelatedField(queryset=Department.objects.all(), source='department', write_only=True)
