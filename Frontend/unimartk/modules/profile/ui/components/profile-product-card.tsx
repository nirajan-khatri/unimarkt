    ...
    >
      ...
      <div className="relative h-48 bg-muted dark:bg-muted overflow-hidden">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2 items-start">
          {/* Status Pill */}
          <Badge
            className={`text-xs font-medium ${getStatusColor(product.status.toLowerCase())}`}
          >
      ...
      <CardContent className="p-5 flex flex-col flex-grow">
        ...
        <div className="space-y-3 mb-4">
          ...
          {/* Date Section */}
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg  dark:bg-accent border border-border">
            <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
