// api.ts
import { SecurityQuestion, UserRole, RegisterData, LoginRequest, LoginResponse } from '../types/auth';

const API_BASE_URL = process.env.NEXT_PUBLIC_BASE_API_URL || "http://localhost:8000/api/";
