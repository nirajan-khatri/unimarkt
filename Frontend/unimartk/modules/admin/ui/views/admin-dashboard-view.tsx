  ...
  return (
    <div className="flex flex-col gap-6 px-4 lg:px-12 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <AdminCard title="Products Listed" value={20} href="/admin/products" />
        <AdminCard
          title="Skills Listed"
          value={12}
        ...
        <AdminCard title="Approval Pending" value={2} href="/admin/approvals" />
        {isSuperAdmin && (
          <>
            <AdminCard
              title="Admins"
        ...
        <AdminCard
          ...
          value={summaryData.approvedFaculty + summaryData.unapprovedFaculty}
          href="/admin/faculty"
        />
      </div>
    </div>
